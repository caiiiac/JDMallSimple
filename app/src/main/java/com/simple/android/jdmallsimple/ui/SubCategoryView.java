...
import com.simple.android.jdmallsimple.listener.IViewContainer;
...
public class SubCategoryView extends FlexiScrollView implements IViewContainer, IModeChangeListener, View.OnClickListener {
    ...
    private void initThirdCategoryItem(List<RTopCategory> thridCategorys,
        ...
        // 6.往列的容器里面添加图片
        String imageUrlPath = thirdCategory.getBannerUrl().replace("http","https");
    ...
    private void initUI() {
        mContainerLl = findViewById(R.id.child_container_ll);
    }
