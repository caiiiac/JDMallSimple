...
import com.simple.android.jdmallsimple.ui.pop.ChooseAreaPopWindow;

public class AddReciverActivity extends BaseActivity implements IAreaChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_reciver);
        initController();
        initUI();
    }
