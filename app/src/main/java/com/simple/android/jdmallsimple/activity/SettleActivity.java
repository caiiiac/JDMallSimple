...
import com.simple.android.jdmallsimple.bean.ROrderParams;
...
import com.simple.android.jdmallsimple.bean.SaddOrderProductParams;
...
import com.simple.android.jdmallsimple.ui.pop.AddOrderDialog;
    ...
    private void initBuyProductModel() {
        ...
        for (int i = 0; i < realSize; i++) {
            ...
            LinearLayout mIemLl = (LinearLayout) mProductContainerLl
                    .getChildAt(i);
            SimpleDraweeView smiv =  mIemLl.findViewById(R.id.piv);
            smiv.setImageURI(data.getPimageUrl().replace("http","https"));
...
//        startActivityForResult(intent, CHOOSE_RECEIVER_REQ);
    ...
    private SAddOrderParams initAddOrderParams() {
        ...
        for (int i = 0; i < mCheckedDatas.size(); i++) {
            ...
            products.add(new SaddOrderProductParams(oldData.getPid(), oldData.getBuyCount(), oldData.getPversion()));
        }
